    ...
    <div class="layout-login__form bg-white" data-perfect-scrollbar>
        <div class="d-flex justify-content-center mt-2 mb-5 navbar-light">
			...
			<!-- Navbar Brand -->
                ...
                <h4 class="m-0 text-center">{{ __('Reset Password') }}</h4>
                ...
                <div class="input-group input-group-merge">		
                                ...
                                <input id="email" type="email" class="form-control form-control-prepended @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="john@doe.com">
				...
				@if (Route::has('admin.login'))			
                   <a class="btn btn-link" href="{{ route('admin.login') }}">{{ __('Back')}}</a>
                @endif
        </form>
    </div>
    </div>
